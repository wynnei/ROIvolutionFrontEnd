    ...
    {images2.length === 0 ? <img src="/assets/images/file-preview.svg" className="max-w-md w-full m-auto" alt="" /> : ''}
        ...
        >
            <div className="mb-5">
                <div className="custom-file-container" data-upload-id="mySecondImage">
                    <div className="label-container">
                        {/* <label>NOTE:Upload four different images of the animal taken in different directions </label> */}
                        {/* <h5>NOTE:Upload four different images of the animal taken in different dirrections </h5> */}
                        <button
                            type="button"
                            className="custom-file-container__image-clear"
                            title="Clear Image"
